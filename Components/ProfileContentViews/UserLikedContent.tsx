...
const UserLikedContents = () => {
  const { userLiked } = useSelector((state: RootState) => state.user);
  ...
  const fetchPosts = async () => {
    try {
      const fetchedPosts = await getPostsByUserIdArray(userLiked);
...
export default UserLikedContents;
