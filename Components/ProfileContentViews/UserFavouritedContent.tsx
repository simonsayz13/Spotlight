...
const UserFavouritedContents = () => {
  const { userFavourites } = useSelector((state: RootState) => state.user);
  ...
  const fetchPosts = async () => {
    try {
      const fetchedPosts = await getPostsByUserIdArray(userFavourites);
...
export default UserFavouritedContents;
